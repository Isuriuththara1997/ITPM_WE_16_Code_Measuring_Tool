...
<body class="building_version" data-spy="scroll" data-target=".header">
      <!-- LOADER -->
      <div id="preloader">
         <img class="preloader" src="images/loaders/#" alt="">
      </div>
      <!-- end loader -->
      <!-- END LOADER -->
         ...
         <nav class="megamenu navbar navbar-default" data-spy="affix">
            ...
            <div class="container">
               <div class="navbar-header">
                  ...
                  <a class="navbar-brand"><span>Code Complexity</span></a>
               </div>
               <div id="navbar" class="navbar-collapse collapse">
                  <ul class="nav navbar-nav navbar-right">
                     <li class="active"><a data-scroll href="#home">Home</a></li>
                     <li><a data-scroll href="#">Size <span class="hidden-xs"></span></a></li>
                     <li><a data-scroll href="#">Variable</a></li>
                     <li><a data-scroll href="#">Methods</a></li>
                     <li><a data-scroll href="#">Inheritance</a></li>
                     <li><a data-scroll href="coupling.jsp">Coupling</a></li>
                     <li><a data-scroll href="#">Control Structure</a></li>
					 <li><a data-scroll href="#">All</a></li>
                  </ul>
               </div>
            </div>
         </nav>
      </header>
      <div id="home" class="parallax first-section" data-stellar-background-ratio="0.4" style="background-image:url('uploads/building/ccc.jpeg');">
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-md-offset-2 text-center">
                  <div class="big-tagline">
                     ...
                     <h2><span class="yellow">Code Complexity</span></h2>
                     ...
                     <a data-scroll href="#services" class="btn btn-light btn-radius btn-brd">UPLOAD</a>
                  </div>
               </div>
            </div>
            <!-- end row -->
                     ...
                     <ul class="item-display-block">
                        <li>
                           ...
                           <div class="info-content">
                              ...
                              <p> SLIIT, New kandy Road, Malabe.</p>
                           </div>
                        </li>
                        <li>
                           <div class="info-shape accent-color background fs-23">
                           ...
                           <div class="info-content">
                              ...
                              <p> +212 854 3675<br>+212 384 5575</p>
                           </div>
                        </li>
                        <li>
                           <div class="info-shape accent-color background fs-23">
               ...
               <div class="col-md-4">
                  <div class="widget widget_text">
                     ...
                     <div class="textwidget">
                        <a class="navbar-brand"><span>Code Complexity</span></a><br>
                        <p>..............................</p>
                     </div>
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="widget widget_links">
                     ...
                     <ul class="wprt-links clearfix col2">
                        <li><a data-scroll="" href="#">Size</a></li>
                        <li><a data-scroll="" href="#">Variable</a></li>
                        <li><a data-scroll="" href="#">Methods</a></li>
                        <li><a data-scroll="" href="#">inheritance</a></li>
                        <li><a data-scroll="" href="coupling.jsp">Coupling</a></li>
                  ...
                  <div class="widget widget_information">
                     ...
                     <ul>
                        <li class="address clearfix">
                           ...
                           <span class="text"> SLIIT, New kandy Road, Malabe.</span>
                        </li>
                        <li class="phone clearfix">
                           <span class="hl">Phone:</span> 
                           <span class="text">+56 (0) 012 748 1235</span>
                        </li>
                        <li class="email clearfix">
                           <span class="hl">E-mail:</span>
                           <span class="text">itpmG16@support.com</span>
                        </li>
                     </ul>
                  </div>
               ...
               <div id="bottom-bar-inner" class="wprt-container">
                  <div class="bottom-bar-inner-wrap">
                     <div class="bottom-bar-content">
                        <div id="copyright">All Rights Reserved. ITPM_G16</div>
                        <!-- /#copyright -->
                     </div>
                     <!-- /.bottom-bar-content -->
